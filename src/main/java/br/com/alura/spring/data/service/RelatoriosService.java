...
public class RelatoriosService {
	...
	public void inicial(Scanner scanner) {
		while (system) {
			System.out.println("Qual busca deseja executar?");
			System.out.println("0 - Sair");
			System.out.println("1 - Busca por nome");
			System.out.println("2 - Busca por nome, data contratação e salário maior");	
			System.out.println("3 - Busca por data contratação");	
